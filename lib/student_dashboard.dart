...
class _GrainPainter extends CustomPainter {
    ...
    void paint(Canvas canvas, Size size) {
      ...
      // very faint left-right pass to mimic brushing
      final brush = Paint()
          ...
          child: isLoading
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildHeader(), // Metal card header
...
Widget _buildHeader() {
  ...
  // Subtle grain painter for the metal texture
  
  // ======================
  // THE REST: UNCHANGED UI
  // ======================
  ...
  Widget _buildQuickStats() {
    return Row(
      children: [
        Expanded(
          child: _buildStatCard('Attendance', '85%', Icons.calendar_today, Colors.green),
        ),
        const SizedBox(width: 12),
        Expanded(
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildFeatureCard('Book Slot', Icons.calendar_month, Colors.orange,
                  _navigateToSlotBooking),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: _buildFeatureCard('Payments', Icons.payment, Colors.green, _navigateToPayments),
            ),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(
              child: _buildFeatureCard('Study Materials', Icons.menu_book, Colors.blue,
                  _navigateToStudyMaterials),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: _buildFeatureCard('Mock Tests', Icons.quiz, Colors.purple, _navigateToMockTests),
            ),
          ],
        ),
      ],
